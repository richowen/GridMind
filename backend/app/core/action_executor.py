...
class ActionExecutor:
    ...
    async def apply_battery(self, result: OptimizationOutput) -> None:
        ...
        current_amps = await ha_client.get_state_float(
            get_setting("ha_entity_discharge_current", "number.foxinverter_max_discharge_current")
        )
    ...
    async def apply_immersion(self, device, decision: ImmersionDecision) -> None:
